...
/**
 * <p>
 * Provides static access to the {@link DNSniperApi} instance.
 * This allows users to access the Template functionality
 * without directly depending on the core implementation.
 * </p>
 */
public final class DNSniperApiProvider {
    private static DNSniperApi instance = null;

    private DNSniperApiProvider() {
        throw new UnsupportedOperationException("This class cannot be instantiated.");
    }

    /**
     * Returns the current {@link DNSniperApi} API instance.
     *
     * @return the registered API instance
     * @throws IllegalStateException if no API implementation is registered
     */
    public static @NotNull DNSniperApi get() {
        DNSniperApi inst = instance;
        if (inst == null) {
     ...
     */
    @ApiStatus.Internal
    public static void register(DNSniperApi api) {
        if (instance != null) {
